...
export function ColorPicker({ selectedColor, onColorChange, customColors, onAddCustomColor }: ColorPickerProps) {
  return (
    <div className="flex bg-gray-300 p-2 border-t border-gray-400">
